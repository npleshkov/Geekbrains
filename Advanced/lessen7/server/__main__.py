...
try:
    ...
    while True:
        ...
        if requests:
            ...
            try:
                ...
                for write_client in wlist:
                    write_client.send(write_client)
                    print('send')
        ...
        # try:
        #     jwt.decode(bytes_response.get('token'), 'secret', algorithms=['HS256'])
        ...
        # except jwt.exceptions.InvalidSignatureError:
        #     pass
            # logging.error(f'Wrong token: {bytes_response.get("token")} not found')
